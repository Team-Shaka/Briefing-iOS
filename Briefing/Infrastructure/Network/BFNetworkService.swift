...
protocol BFNetworkService {
    ...
    func response<D: Codable>(_ briefingURLRequest: any BFEndpoints,
    ...
    func response(_ briefingURLRequest: any BFEndpoints) -> Single<Data>
